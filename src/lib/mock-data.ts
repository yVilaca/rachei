...
export const MOCK_DEBTS: Debt[] = [
  {
    ...
    installments: [
      { id: 'inst-1a', debtId: 'debt-1', debtorUserId: 'user-lucas', amountCents: 8000, status: 'paid', paidAt: '2026-06-03T10:00:00Z', confirmedAt: '2026-06-03T11:00:00Z', debtor: MOCK_USERS[1], proof: { id: 'proof-1', installmentId: 'inst-1a', fileUrl: '', uploadedAt: '2026-06-03T10:00:00Z' } },
      { id: 'inst-1b', debtId: 'debt-1', debtorUserId: 'user-carol', amountCents: 8000, status: 'awaiting_confirmation', paidAt: '2026-06-04T09:00:00Z', debtor: MOCK_USERS[2], proof: { id: 'proof-2', installmentId: 'inst-1b', fileUrl: '', uploadedAt: '2026-06-04T09:00:00Z' } },
      { id: 'inst-1c', debtId: 'debt-1', debtorUserId: 'user-bruno', amountCents: 8000, status: 'pending', debtor: MOCK_USERS[3] },
    ],
  },
  {
    id: 'debt-2',
    ...
    installments: [
      { id: 'inst-2a', debtId: 'debt-2', debtorUserId: 'user-sofia', amountCents: 22500, status: 'pending', debtor: MOCK_USERS[0], chargeLink: { id: 'link-1', installmentId: 'inst-2a', token: 'abc123tk', expiresAt: '2026-07-20T10:00:00Z' } },
      { id: 'inst-2b', debtId: 'debt-2', debtorUserId: 'user-carol', amountCents: 22500, status: 'pending', debtor: MOCK_USERS[2] },
      { id: 'inst-2c', debtId: 'debt-2', debtorUserId: 'user-bruno', amountCents: 22500, status: 'paid', paidAt: '2026-06-01T10:00:00Z', confirmedAt: '2026-06-01T11:00:00Z', debtor: MOCK_USERS[3], proof: { id: 'proof-3', installmentId: 'inst-2c', fileUrl: '', uploadedAt: '2026-06-01T10:00:00Z' } },
    ],
  },
  {
    id: 'debt-3',
    ...
    installments: [
      { id: 'inst-3a', debtId: 'debt-3', debtorUserId: 'user-lucas', amountCents: 6000, status: 'paid', paidAt: '2026-06-06T10:00:00Z', confirmedAt: '2026-06-06T11:00:00Z', debtor: MOCK_USERS[1], proof: { id: 'proof-4', installmentId: 'inst-3a', fileUrl: '', uploadedAt: '2026-06-06T10:00:00Z' } },
      { id: 'inst-3b', debtId: 'debt-3', debtorUserId: 'user-ana', amountCents: 6000, status: 'pending', debtor: MOCK_USERS[4] },
    ],
  },
  {
    id: 'debt-4',
    ...
    installments: [
      { id: 'inst-4a', debtId: 'debt-4', debtorUserId: 'user-sofia', amountCents: 4000, status: 'pending', debtor: MOCK_USERS[0] },
      { id: 'inst-4b', debtId: 'debt-4', debtorUserId: 'user-ana', amountCents: 4000, status: 'pending', debtor: MOCK_USERS[4] },
    ],
  },
]
